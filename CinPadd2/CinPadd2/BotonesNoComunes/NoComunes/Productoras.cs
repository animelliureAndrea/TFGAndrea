...
{
    public partial class Productoras : Form
    {
        string cadena = "Data Source=FCMPORT2-WIN10;Initial Catalog=tfgCinPadd;Integrated Security=True;";
        SqlConnection conex;
        int idUser;
        public Productoras(int IdUsuario)
        {
            InitializeComponent();
            this.idUser = IdUsuario;
            llenarTablaProductoras();
        }

        private void llenarTablaProductoras()
        {
            ...
            string consultaProductoras = "select * from productora";
            SqlCommand cmd = new SqlCommand(consultaProductoras, conex);
            ...
            dtgProductora.DataSource = datos.Tables[0];
